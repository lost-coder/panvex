...
// /api/agent/recover-certificate endpoint. Unlike bootstrap (A9), recovery
// still uses panel-generated keys (pre-CSR migration); PrivateKeyPEM is
// included here until recovery is migrated to CSR-based issuance.
