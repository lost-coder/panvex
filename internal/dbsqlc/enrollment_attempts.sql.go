...
const listEnrollmentAttempts = `-- name: ListEnrollmentAttempts :many
SELECT id, token_id, agent_id, mode, client_addr, request_id,
       status, error_code, error_message, started_at, finished_at
...
// disable a filter.
func (q *Queries) ListEnrollmentAttempts(ctx context.Context, arg ListEnrollmentAttemptsParams) ([]EnrollmentAttempt, error) {
	rows, err := q.db.QueryContext(ctx, listEnrollmentAttempts,
		arg.TokenID,
		arg.AgentID,
		arg.Status,
		arg.Mode,
