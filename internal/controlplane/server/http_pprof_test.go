...
func TestPprofAdminOnly(t *testing.T) {
	...
	indexResponse := performJSONRequest(t, server, http.MethodGet, "/api/debug/pprof/", nil, adminCookies)
	...
	goroutineResponse := performJSONRequest(t, server, http.MethodGet, "/api/debug/pprof/goroutine?debug=1", nil, adminCookies)
	...
	viewerResponse := performJSONRequest(t, server, http.MethodGet, "/api/debug/pprof/", nil, viewerCookies)
	...
	anonResponse := performJSONRequest(t, server, http.MethodGet, "/api/debug/pprof/", nil, nil)
