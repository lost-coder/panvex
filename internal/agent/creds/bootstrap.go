...
func Bootstrap(ctx context.Context, client *http.Client, config BootstrapConfig) (agentstate.Credentials, error) {
	...
	credentialsState := agentstate.Credentials{
		...
		// (see recoverCredentials) can honor it without
...
func recoverCredentials(ctx context.Context, stateFile string, current agentstate.Credentials, client *http.Client, now time.Time) (agentstate.Credentials, error) {
